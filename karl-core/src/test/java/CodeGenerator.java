...
public class CodeGenerator {
    ...
    private static String AUTHOR = "karl";
    private static String DATABASE = "karl";
    private static String DATABASE_USERNAME = "karl";
    private static String DATABASE_PASSWORD = "karl";
    private static String PROJECT = "com.karl.module";
